...
import net.phylax.credible.types.SidecarApiModels.GetTransactionsRequest;
...
public class JsonRpcTransport implements ISidecarTransport {
    ...
    public JsonRpcTransport(String baseUrl, CredibleMetricsRegistry metricsRegistry) {
        this(baseUrl, createDefaultHttpClient(), metricsRegistry);
    }

    public JsonRpcTransport(String baseUrl, Call.Factory httpClient, CredibleMetricsRegistry metricsRegistry) {
    ...
    public static class Builder {
        ...
        public JsonRpcTransport build() {
            ...
            return new JsonRpcTransport(baseUrl, clientBuilder.build(), metricsRegistry);
        }
    }
    ...
    @Override
    public CompletableFuture<GetTransactionsResponse> getTransactions(GetTransactionsRequest transactions) {
        return this.callAsync(
    ...
    @Override
    public CompletableFuture<GetTransactionResponse> getTransaction(GetTransactionRequest transaction) {
        return this.callAsync(
